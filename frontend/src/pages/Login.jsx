        ...
        <div className="bg-slate-800/30 backdrop-blur-2xl rounded-3xl shadow-2xl p-8 border border-slate-600/30 relative overflow-hidden animate-slide-in-right">
          ...
          <div className="relative space-y-8">
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              {/* Error Message */}
              {error && (
                <div className="bg-red-500/20 border border-red-400/30 text-red-200 px-6 py-4 rounded-2xl flex items-center space-x-3 backdrop-blur-xl animate-fade-in-delay-2">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full relative bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold py-4 px-6 rounded-2xl transition-all duration-500 transform hover:scale-[1.02] disabled:opacity-50 shadow-2xl hover:shadow-blue-500/25 overflow-hidden text-lg group"
              >
            ...
            <div className="text-center pt-4 border-t border-slate-600/20 animate-fade-in-delay-3">
              ...
              >
                <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent group-hover:from-white group-hover:to-white">
                  Create your account
                </span>
